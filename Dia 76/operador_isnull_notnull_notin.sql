...
-- Consultas com Is Null & Not Null/In
-- Recuperar o nome e o número do departamento dos empregados que ainda não possuem supervisor
select pnome, dnr
from funcionario
where cpf_supervisor is null;

-- Recuperar o nome e o número do departamento dos empregados que possuem supervisor
select pnome, dnr
from funcionario
where cpf_supervisor is not null;

-- Recuperar todas as informações dos funcionários cujo último nome não seja "Souza"
select *
from funcionario
