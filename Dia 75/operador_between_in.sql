...
-- Consultas com Between & in 
-- Recuperar todos os funcionários no departamento 5 cujo salário esteja entre 20000 e 40000
select *
from funcionario
where (salario between 20000 and 40000) and dnr=5;

-- Recuperar o nome e endereço de todos os funcionários que trabalham para o departamento de pesquisa

select pnome, unome, endereco, dnr
from funcionario
