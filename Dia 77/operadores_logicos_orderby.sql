...
-- Consultas com operadores lógicos e Order By
...
-- Recuperar o primeiro nome e o salario do funcionário em que o salário é maior ou igual  a 30mil ordenado pelo último nome
select pnome, salario
from funcionario
where salario >= 30000 order by unome;

-- Recuperar o nome e endereço de todos funcionários que trabalham para o departamento de pesquisa
-- ordene pelo primeiro nome descendente
select pnome, unome, endereco
from funcionario, departamento
where dnome = "Pesquisa" and dnr = 5
order by pnome DESC;
