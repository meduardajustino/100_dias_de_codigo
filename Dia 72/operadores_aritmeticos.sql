...
-- Consultas
-- Recuperar o primeiro nome e o salário do funcionário em que o salário é maior ou igual a 30000
select pnome, salario
from funcionario
where salario >= 30000;

-- Recuperar a data de nascimento e endereço do(s) funcionários(s) cujo nome seria "João B. Silva"
select datanasc, endereco
from funcionario
where pnome = 'João' and minicial = 'B' and unome = 'Silva';

-- Recuperar todos os valores de atributo de qualquer funcionário que trabalha no
